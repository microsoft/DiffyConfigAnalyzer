...
namespace Diffy.Regex
{
    ...
    /// </summary>
    internal sealed class RegexAnchorExpr : Regex
    {
        /// <summary>
        /// The begin anchor Regex instance.
        /// </summary>
        public static Regex BeginInstance = new RegexAnchorExpr(true);

        /// <summary>
        /// The end anchor Regex instance.
        /// </summary>
        public static Regex EndInstance = new RegexAnchorExpr(false);
